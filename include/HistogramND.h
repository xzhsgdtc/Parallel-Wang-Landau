...
public:
    ...
    /**
     * Given the observables ( usually energy ), return the g(E)
     * @param observables 
    ...
    /**
     * Given the observables (usually energy), check whether it is (they are) within
     * the limit(s) of histogram.
     * @param observables
     * @return boolean value
     */
    inline bool isInLimit(const double* observables){
