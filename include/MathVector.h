...
public:    
    ...
    /**
     * Apply periodic boundary for given dimension
     * @param d dimension
     * @param l left boundary coordinate
     * @param r right boundary coordinate
     * @return 
     */
    void periodic(const long& d, const T& l, const T& r);
     ...
     */
    void minImage(const long& d, const T& length);
...
template<class T>
void MathVector<T>::periodic(const long& d, const T& l, const T& r){
    T L = r - l; // distance between left and right boundary 
    mCoord[d] = mCoord[d] - L * floor( mCoord[d]/L ) + l; 
}

template<class T>
void MathVector<T>::periodic(const T& l, const T& r){
    T L = r - l; // distance between left and right boundary 
